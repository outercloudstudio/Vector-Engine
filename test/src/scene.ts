...
import { Ease, Ellipse, Linear, Rect, SceneContext, Vector, VectorImage, VectorText, VectorVideo, color, reactive } from '@vector-engine/core'
...
export default async function* ({ add, relative, aside }: SceneContext) {
	...
	yield* image.rotation(360, 1, Linear)
